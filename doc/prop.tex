...
% \subsection{Instance search space
% configuration}\label{instance-search-space-configuration}
% 
...
% inside a specific module path \texttt{PATH}. It can support other
% instance search policies easily, since the implicit resolution algorithm
% itself is almost orthogonal to the definitions of instance search
% spaces.
% 
...
% \texttt{Sexplib.Sexp.sexp\_of*}. Many library functions for data types
% which take sub-functions for their parameter types can be easily
% integrated by this algorithm.

...
module SumList(Num : Numdef.Num [@typeclass a Numdef.Num]) (* : Sum with type c = Num.a list and type n = Num.a *) = struct
  open Num
  type c = Num.a list
  type n = Num.a
...
module SumArray(Num : Numdef.Num [@typeclass a Numdef.Num]) = struct
  open Num
  type c = Num.a array
  type n = Num.a
